...
if ($settings['overlay_animation'] == 'slide' && !in_array($settings['overlay'], ['center', 'middle-left'])) {
...
<div<?php echo $class; ?> data-<?php echo $cssprefix?>-slideshow="<?php echo $options; ?>" id="<?php echo $lightbox_class; ?>">
    ...
    <div class="<?php echo $position_relative; ?>">
        ...
        <ul class="<?php echo $cssprefix?>-slideshow<?php if ($settings['fullscreen']) {
    echo ' '.$cssprefix.'-slideshow-fullscreen';
} ?><?php if ($settings['overlay'] != 'none') {
    echo ' '.$cssprefix.'-overlay-active';
} ?>">
            ...
            <li style="min-height: <?php echo $settings['min_height']; ?>px;">
                ...
                <?php if ($item['media'] && $settings['media']) : ?>
                    ...
                    <div class="<?php echo $overlay; ?>">
                        ...
                        <?php if (in_array($settings['overlay'], ['center', 'middle-left'])) : ?>
                        <div>
                        <?php endif; ?>
        ...
        <?php if (in_array($settings['slidenav'], ['top-left', 'top-right', 'bottom-left', 'bottom-right'])) : ?>
        <div class="<?php echo $cssprefix?>-position-<?php echo $settings['slidenav']; ?> <?php echo $cssprefix?>-margin <?php echo $cssprefix?>-margin-left <?php echo $cssprefix?>-margin-right">
            <div class="<?php echo $cssprefix?>-grid <?php echo $cssprefix?>-grid-small">
                <div><a href="#" class="<?php echo $cssprefix?>-slidenav <?php if ($settings['nav_contrast']) {
                        echo $cssprefix.'-slidenav-contrast';
                    } ?> <?php echo $cssprefix?>-slidenav-previous" data-<?php echo $cssprefix?>-slideshow-item="previous"><span class="uk-hidden"><?php echo $WCAG_prev; ?></span></a></div>
                <div><a href="#" class="<?php echo $cssprefix?>-slidenav <?php if ($settings['nav_contrast']) {
                        echo $cssprefix.'-slidenav-contrast';
                    } ?> <?php echo $cssprefix?>-slidenav-next" data-<?php echo $cssprefix?>-slideshow-item="next"><span class="uk-hidden"><?php echo $WCAG_next; ?></span></a></div>
            </div>
        </div>
        <?php elseif ($settings['slidenav'] == 'default') : ?>
            <a href="#" class="<?php echo $cssprefix?>-slidenav <?php if ($settings['nav_contrast']) {
                        echo $cssprefix.'-slidenav-contrast';
                    } ?> <?php echo $cssprefix?>-slidenav-previous <?php echo $cssprefix?>-hidden-touch" data-<?php echo $cssprefix?>-slideshow-item="previous"><span class="uk-hidden"><?php echo $WCAG_prev; ?></span></a>
            <a href="#" class="<?php echo $cssprefix?>-slidenav <?php if ($settings['nav_contrast']) {
                        echo $cssprefix.'-slidenav-contrast';
                    } ?> <?php echo $cssprefix?>-slidenav-next <?php echo $cssprefix?>-hidden-touch" data-<?php echo $cssprefix?>-slideshow-item="next"><span class="uk-hidden"><?php echo $WCAG_next; ?></span></a>
        <?php endif ?>
